...
public extension SceneLocationView {
    ...
    func removePolylineNodeFromScene(_ node: PolylineNode) {
        print("\(sceneNode?.childNodes.count) children before removal")
        node.boxBuilder = nil
        ...
        print("\(sceneNode?.childNodes.count) children after removal")
    }
